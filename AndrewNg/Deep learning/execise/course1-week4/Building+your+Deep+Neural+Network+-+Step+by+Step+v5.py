...
def L_model_forward(X, parameters):
    ...
    for l in range(1, L):
        ...
        #print('W' + str(l) + str(parameters['W' + str(l)])) # (4,5), (3,4)
        #print('A' + str(l) + str(A)) # (4,4), (3,4)
        caches.append(cache)
    ...
    ### START CODE HERE ### (≈ 2 lines of code)
    #print('A=' + str(A)) # (3,4)
    #print('AL-1=' + str(A[L-1])) # (1,4)
    #print('WL=' + str(parameters['W' + str(L)])) # (1,3)
    AL, cache = linear_activation_forward(A, parameters['W' + str(L)], parameters['b' + str(L)], activation = "sigmoid")
    caches.append(cache)

    ### END CODE HERE ###
    
    assert(AL.shape == (1,X.shape[1])) # AL=(1,4)
...
def compute_cost(AL, Y):
    ...
    #print('m=' + str(m)) # m=3
    #print('AL' + str(AL.shape)) # AL = (1,3)
    #print('Y' + str(Y.shape)) # Y= (1,3)
